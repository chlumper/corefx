...
namespace System.Threading.Tasks
{
    ...
    internal sealed class ManualResetValueTaskObject<T> : IValueTaskObject<T>
    {
        ...
        public ManualResetValueTaskObject<T> ConfigureAwait(bool continueOnCapturedContext)
        {
            _continueOnCapturedContext = continueOnCapturedContext;
            return this;
        }

        IValueTaskObject<T> IValueTaskObject<T>.ConfigureAwait(bool continueOnCapturedContext) => ConfigureAwait(continueOnCapturedContext);
