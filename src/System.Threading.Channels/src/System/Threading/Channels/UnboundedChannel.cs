...
namespace System.Threading.Channels
{
    ...
    internal sealed class UnboundedChannel<T> : Channel<T>, IDebugEnumerable<T>
    {
            ...
            public override bool TryWrite(T item)
            {
                ...
                while (true)
                {
                    ...
                    lock (parent.SyncObj)
                    {
                        ...
                        waitingReaders = parent._waitingReadersTail;
                    ...
                    ChannelUtilities.WakeUpWaiters(ref waitingReaders, true, returnCache: _parent._waitingReadersCache);
                    return true;
                }
            }
        ...
        private void AssertInvariants()
        {
            ...
            if (_waitingReadersTail != null && _runContinuationsAsynchronously)
            {
