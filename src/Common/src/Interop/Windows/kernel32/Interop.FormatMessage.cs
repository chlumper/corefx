    ...
    internal partial class Kernel32
    {
        ...
        internal static string GetMessage(IntPtr moduleHandle, int errorCode)
        {
            ...
            do
            {
                ...
                {
                    ReturnPoolBuffer(arrayPoolBuffer);
                    return errorMsg;
                }

                // Increase the capacity of the buffer.
                ReturnPoolBuffer(arrayPoolBuffer);
                buffer = arrayPoolBuffer = ArrayPool<char>.Shared.Rent(buffer.Length * BufferSizeIncreaseFactor);
            }
        ...
        private static bool TryGetErrorMessage(IntPtr moduleHandle, int errorCode, Span<char> buffer, out string errorMsg)
        {
            ...
            if (result != 0)
            {
                ...
                errorMsg = new string(buffer.Slice(0, i));
            }
